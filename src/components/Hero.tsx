        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              <Button asChild variant="outline" className="border-brilliant-blue text-brilliant-blue hover:bg-brilliant-blue/10 text-lg py-6 px-8">
                <Link to="/register">
          ...
          <div className="relative animate-fade-in order-first lg:order-last">
            ...
            <div className="absolute -bottom-6 -right-6 w-40 h-40 bg-green-400/20 rounded-full blur-2xl -z-10"></div>
            <div className="absolute -top-6 -left-6 w-40 h-40 bg-indigo-800/20 rounded-full blur-2xl -z-10"></div>
          </div>
        </div>
      </div>
